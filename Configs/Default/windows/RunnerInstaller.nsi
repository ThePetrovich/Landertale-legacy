...
!ifndef COMPANY_NAME
!define COMPANY_NAME      "Мультимедиа ЦТТ"
!endif
...
!ifndef FILE_DESC
!define FILE_DESC         "Создано с помощью GameMaker: Studio"
!endif
...
;
Section "Установка DirectX" SEC_DIRECTX
 
 SectionIn RO
 
 SetOutPath "$TEMP"
 File "${MAKENSIS}\dxwebsetup.exe"
 DetailPrint "Запуск установкщика DirectX..."
 ExecWait '"$TEMP\dxwebsetup.exe" /Q' $DirectXSetupError
 DetailPrint "Установка DirectX завершена"
